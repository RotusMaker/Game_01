...
public class MaterialColorSlider : MonoBehaviour {
	...
	void Update () {
		...
		if (ColorSelection == 3) { Color_R = 1f; Color_G = 0.6784314f; Color_B = 0f;}
		...
		renderer.material.color = new Color (Color_R, Color_G, Color_B);
	}
